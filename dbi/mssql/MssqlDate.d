...
public:
  ...
  char[] getString() {
    ...
    return 
      toDString(dr.dateyear) ~ "-" ~
      pad(toDString(dr.datemonth)) ~ "-" ~
      pad(toDString(dr.datedmonth)) ~ " " ~
      pad(toDString(dr.datehour)) ~ ":" ~
      pad(toDString(dr.dateminute)) ~ ":" ~
      pad(toDString(dr.datesecond));
  }
