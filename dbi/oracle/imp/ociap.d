 ...
 *
 */
deprecated extern (C) sword OCIStmtBindByPos (OCIStmt* stmtp, OCIBind* bindp, OCIError* errhp, ub4 position, dvoid* valuep, sb4 value_sz, ub2 dty, dvoid* indp, ub2* alenp, ub2* rcodep, ub4 maxarr_len, ub4* curelep, ub4 mode);

/**
 *
 */
deprecated extern (C) sword OCIStmtBindByName (OCIStmt* stmtp, OCIBind* bindp, OCIError* errhp, OraText* placeholder, sb4 placeh_len, dvoid* valuep, sb4 value_sz, ub2 dty, dvoid* indp, ub2* alenp, ub2* rcodep, ub4 maxarr_len, ub4* curelep, ub4 mode);
